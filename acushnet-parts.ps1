...
if (Test-Path -Path "$env:USERPROFILE\Documents\Acushnet directory") {
    $acushnetDirectory = "$env:USERPROFILE\Documents\Acushnet directory"  
}
elseif (Test-Path -Path "$env:USERPROFILE\Desktop\Acushnet directory") {
    $acushnetDirectory = "$env:USERPROFILE\Desktop\Acushnet directory" 
}
else {
    Write-Host "Directory does not exist!"
}

$inputPath = "$acushnetDirectory\input\input.xlsx"
$outputPath = "$acushnetDirectory\output\output.txt"
